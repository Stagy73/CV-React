  ...
  return (
    <div className="bigContainer">
      <div className="info-container">
        ...
        <div className="address">26000 valence</div>
        ...
        <div>
          <a href="https://github.com/Stagy73">
            <img
        ...
        <div>
          <a href="https://www.linkedin.com/in/nils-mehlhorn-51152823b/">
            <img
              src="https://www.1min30.com/wp-content/uploads/2017/08/LinkedIn-logo.jpg"
              alt=""
              width="50px"
              height="50px"
            />
